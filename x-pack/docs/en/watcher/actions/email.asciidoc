...
xpack.notification.email.account:
    gmail_account:
        ...
        smtp:
            ...
            port: 587
            user: <username>
            secure_password: <xpack.notification.email.account.gmail_account.smtp.secure_password>
--------------------------------------------------
...
xpack.notification.email.account:
    outlook_account:
        ...
        smtp:
            ...
            port: 587
            user: <email.address>
            secure_password: <xpack.notification.email.account.outlook_account.smtp.secure_password>
--------------------------------------------------
...
xpack.notification.email.account:
    ses_account:
        smtp:
            ...
            port: 587
            user: <username>
            secure_password: <xpack.notification.email.account.ses_account.smtp.secure_password>
--------------------------------------------------
...
xpack.notification.email.account:
    exchange_account:
        ...
        smtp:
            ...
            secure_password: <xpack.notification.email.account.exchange_account.smtp.secure_password>
--------------------------------------------------
